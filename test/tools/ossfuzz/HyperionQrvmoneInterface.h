...
struct CompilerInput
{
	CompilerInput(
		...
		std::map<std::string, hyperion::util::h384> _libraryAddresses,
	...
	std::map<std::string, hyperion::util::h384> libraryAddresses;
...
public:
	...
	void libraryAddresses(std::map<std::string, hyperion::util::h384> _libraryAddresses)
	{
