...
std::string YulUtilFunctions::overflowCheckedIntAddFunction(IntegerType const& _type)
{
	...
	return m_functionCollector.createFunction(functionName, [&]() {
		return
			...
			("maxValue", toCompactHexWithPrefix(u512(bigint(_type.maxValue()) & ((bigint(1) << VMWordBits) - 1))))
			("minValue", toCompactHexWithPrefix(u512(bigint(_type.minValue()) & ((bigint(1) << VMWordBits) - 1))))
...
std::string YulUtilFunctions::overflowCheckedIntDivFunction(IntegerType const& _type)
{
	...
	return m_functionCollector.createFunction(functionName, [&]() {
		return
			...
			("functionName", functionName)
			("signed", _type.isSigned())
			("minVal", toCompactHexWithPrefix(u512(bigint(_type.minValue()) & ((bigint(1) << VMWordBits) - 1))))
			("cleanupFunction", cleanupFunction(_type))
...
std::string YulUtilFunctions::decrementCheckedFunction(Type const& _type)
{
	...
	return m_functionCollector.createFunction(functionName, [&]() {
		...
		("functionName", functionName)
		("panic", panicFunction(PanicCode::UnderOverflow))
		("minval", toCompactHexWithPrefix(u512(bigint(type.minValue()) & ((bigint(1) << VMWordBits) - 1))))
		("cleanupFunction", cleanupFunction(_type))
		.render();
	});
}
...
std::string YulUtilFunctions::incrementCheckedFunction(Type const& _type)
{
	...
	return m_functionCollector.createFunction(functionName, [&]() {
		...
		("functionName", functionName)
		("maxval", toCompactHexWithPrefix(u512(bigint(type.maxValue()) & ((bigint(1) << VMWordBits) - 1))))
		("panic", panicFunction(PanicCode::UnderOverflow))
		("cleanupFunction", cleanupFunction(_type))
		.render();
	});
...
std::string YulUtilFunctions::panicFunction(util::PanicCode _code)
{
	...
	return m_functionCollector.createFunction(functionName, [&]() {
		// Panic(uint512) ABI: selector (4 bytes) + one VM word for the code.
		...
		("functionName", functionName)
		("shlExtra", shiftLeftFunction(VMWordBits - 256))
		("selector", util::selectorFromSignatureU256("Panic(uint512)").str())
