...
private:
	...
	static std::array<std::unique_ptr<IntegerType>, 48> const m_intM;
	static std::array<std::unique_ptr<IntegerType>, 48> const m_uintM;
	static std::array<std::unique_ptr<FixedBytesType>, 48> const m_bytesM;
