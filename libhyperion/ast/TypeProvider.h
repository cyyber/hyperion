...
private:
	...
	static std::array<std::unique_ptr<IntegerType>, VMWordBytes> const m_intM;
	static std::array<std::unique_ptr<IntegerType>, VMWordBytes> const m_uintM;
	static std::array<std::unique_ptr<FixedBytesType>, VMWordBytes> const m_bytesM;
