...
struct LinkerObject
{
	...
	/// @returns a hash string used inside the library-address placeholder.
	/// The bytecode placeholder spans 2 * AddressBytes hex characters once
	/// enclosed by `__` on both sides.
